...
const headstockConfigs = {
  guitar6: {
    image: 'assets/headstocks/guitar6.svg',
    width: 360, height: 700, bubble: 52, bubbleCoord: 46,
    hotspots: [
      { peg: { x: 98, y: 430 }, label: { x: 54, y: 430 } },
      { peg: { x: 98, y: 330 }, label: { x: 54, y: 330 } },
      { peg: { x: 98, y: 230 }, label: { x: 54, y: 230 } },
      { peg: { x: 262, y: 230 }, label: { x: 306, y: 230 } },
      { peg: { x: 262, y: 330 }, label: { x: 306, y: 330 } },
      { peg: { x: 262, y: 430 }, label: { x: 306, y: 430 } }
    ]
  },
  guitar12: {
    image: 'assets/headstocks/guitar12.svg',
    width: 420, height: 700, bubble: 42, bubbleCoord: 36,
    hotspots: [
      { peg: { x: 92, y: 460 }, label: { x: 50, y: 460 } },
      { peg: { x: 92, y: 410 }, label: { x: 50, y: 410 } },
      { peg: { x: 92, y: 360 }, label: { x: 50, y: 360 } },
      { peg: { x: 92, y: 310 }, label: { x: 50, y: 310 } },
      { peg: { x: 92, y: 260 }, label: { x: 50, y: 260 } },
      { peg: { x: 92, y: 210 }, label: { x: 50, y: 210 } },
      { peg: { x: 328, y: 210 }, label: { x: 370, y: 210 } },
      { peg: { x: 328, y: 260 }, label: { x: 370, y: 260 } },
      { peg: { x: 328, y: 310 }, label: { x: 370, y: 310 } },
      { peg: { x: 328, y: 360 }, label: { x: 370, y: 360 } },
      { peg: { x: 328, y: 410 }, label: { x: 370, y: 410 } },
      { peg: { x: 328, y: 460 }, label: { x: 370, y: 460 } }
    ]
  },
  bass4: {
    image: 'assets/headstocks/bass4.svg',
    width: 360, height: 700, bubble: 50, bubbleCoord: 44,
    hotspots: [
      { peg: { x: 108, y: 410 }, label: { x: 58, y: 410 } },
      { peg: { x: 108, y: 290 }, label: { x: 58, y: 290 } },
      { peg: { x: 244, y: 250 }, label: { x: 302, y: 250 } },
      { peg: { x: 244, y: 370 }, label: { x: 302, y: 370 } }
    ]
  },
  ukulele: {
    image: 'assets/headstocks/ukulele.svg',
    width: 360, height: 700, bubble: 50, bubbleCoord: 44,
    hotspots: [
      { peg: { x: 126, y: 430 }, label: { x: 62, y: 430 } },
      { peg: { x: 126, y: 250 }, label: { x: 62, y: 250 } },
      { peg: { x: 234, y: 250 }, label: { x: 298, y: 250 } },
      { peg: { x: 234, y: 430 }, label: { x: 298, y: 430 } }
    ]
  },
  violin: {
    image: 'assets/headstocks/violin.svg',
    width: 360, height: 700, bubble: 50, bubbleCoord: 44,
    hotspots: [
      { peg: { x: 206, y: 335 }, label: { x: 78, y: 410 } },
      { peg: { x: 198, y: 215 }, label: { x: 78, y: 250 } },
      { peg: { x: 250, y: 245 }, label: { x: 302, y: 250 } },
      { peg: { x: 258, y: 365 }, label: { x: 302, y: 410 } }
    ]
  },
  mandolin: {
    image: 'assets/headstocks/mandolin.svg',
    width: 360, height: 700, bubble: 42, bubbleCoord: 36,
    hotspots: [
      { peg: { x: 94, y: 435 }, label: { x: 48, y: 435 } },
      { peg: { x: 94, y: 360 }, label: { x: 48, y: 360 } },
      { peg: { x: 94, y: 285 }, label: { x: 48, y: 285 } },
      { peg: { x: 94, y: 210 }, label: { x: 48, y: 210 } },
      { peg: { x: 266, y: 210 }, label: { x: 312, y: 210 } },
      { peg: { x: 266, y: 285 }, label: { x: 312, y: 285 } },
      { peg: { x: 266, y: 360 }, label: { x: 312, y: 360 } },
      { peg: { x: 266, y: 435 }, label: { x: 312, y: 435 } }
    ]
  },
  banjo5: {
    image: 'assets/headstocks/banjo5.svg',
    width: 360, height: 700, bubble: 46, bubbleCoord: 40,
    hotspots: [
      { peg: { x: 130, y: 500 }, label: { x: 74, y: 500 } },
      { peg: { x: 116, y: 355 }, label: { x: 70, y: 355 } },
      { peg: { x: 116, y: 230 }, label: { x: 70, y: 230 } },
      { peg: { x: 244, y: 230 }, label: { x: 290, y: 230 } },
      { peg: { x: 244, y: 355 }, label: { x: 290, y: 355 } }
    ]
  }
};
...
function renderHeadstock(){
  ...
  notes.forEach((item,i)=>{
    ...
    const bubbleCoord=hotspot.bubbleCoord||config.bubbleCoord||Math.max(28,bubbleSize*0.86);
    const dx=hotspot.label.x-hotspot.peg.x;
    const dy=hotspot.label.y-hotspot.peg.y;
    const len=Math.hypot(dx,dy)||1;
    const lineEndX=hotspot.label.x-(dx/len)*(bubbleCoord*0.52);
    const lineEndY=hotspot.label.y-(dy/len)*(bubbleCoord*0.52);
    ...
    dot.setAttribute('r',Math.max(5.5, Math.round((bubbleCoord)*0.17)));
